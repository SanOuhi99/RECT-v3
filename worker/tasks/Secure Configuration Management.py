...
# DataTree API Configuration
DATATREE_CLIENT_ID=your_client_id_here
DATATREE_CLIENT_SECRET=your_client_secret_here
DATATREE_TIMEOUT=30
DATATREE_MAX_RETRIES=3

# Email Configuration
SMTP_SERVER=smtp.mailgun.org
SMTP_PORT=587
SENDER_EMAIL=support@info.realestateclienttracker.com
SMTP_USERNAME=support@info.realestateclienttracker.com
