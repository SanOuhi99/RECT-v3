...
with open(credentials_FILE, "r") as f:
    ...
    SMTP_PORT = lines[3].strip()
    SENDER_EMAIL = lines[4].strip()
    SMTP_USERNAME = lines[5].strip()
    SMTP_PASSWORD = lines[6].strip()
...
def save_to_excel(data_to_be_saved, crm_owner):
    ...
    retries = 0
    max_retries = 10  # Maximum attempts to access the file
